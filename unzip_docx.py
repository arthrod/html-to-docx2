...
def display_file_contents(file_or_folder_path: str, original_file: str, output_file=None) -> str:
            ...
            try:
                with open(output_filename, 'w', encoding='utf-8') as f:
                    ...
                    for item_path, original_file in extracted_items:
                        display_file_contents(item_path, original_file, f)
                ...
                print(header)
                for item_path, original_file in extracted_items:
                    display_file_contents(item_path, original_file)
        else:
