...
const buildParagraphBorder = (): XMLBuilderType => {
  ...
  // ⚡ Bolt: Removed `cloneDeep(paragraphBordersObject)` and `Object.keys().forEach`
  // loop, replacing them with `for...of Object.entries()` to avoid unnecessary
  // memory allocations and redundant lookups on a static configuration object.
