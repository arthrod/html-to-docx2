...
const buildParagraphBorder = (): XMLBuilderType => {
  ...
  // ⚡ Bolt: Removed expensive cloneDeep and Object.keys().forEach() array allocation in favor of
  // direct Object.entries iteration over the static paragraphBordersObject configuration.
