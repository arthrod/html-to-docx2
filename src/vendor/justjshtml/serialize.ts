...
interface TestFormatOptions {
  foreignAttributeAdjustments?: Record<string, [string | null, string, string]> | null;
}
...
export function toHTML(node: any, { indent = 0, indentSize = 2, pretty = true }: ToHTMLOptions = {}): string {
