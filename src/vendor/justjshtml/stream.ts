...
export function* stream(html: string | Uint8Array | ArrayBuffer | null | undefined, { encoding = null, tokenizerOpts = null }: StreamOptions = {}): Generator<StreamEvent, void, unknown> {
  let input = html
  if (input == null) input = ''
