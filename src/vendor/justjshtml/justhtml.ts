...
export interface JustHTMLOptions {
  ...
  strict?: boolean
  fragmentContext?: unknown // Retaining as 'unknown' for now since parseDocument doesn't type it
  iframeSrcdoc?: boolean
  tokenizerOpts?: unknown // Retaining as 'unknown' for now since parseDocument doesn't type it
}
