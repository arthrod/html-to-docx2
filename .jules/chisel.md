...
## 2026-07-03 - Mid-file imports trigger linter errors\n**Learning:** When using .cjs scripts to inject new type dependencies like `import { ParseError }`, placing the import mid-file triggers linter errors and code review failures.\n**Action:** Always inject new `import` statements at the top of the file alongside existing imports.\n
