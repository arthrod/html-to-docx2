...
describe('Image Dimensions', () => {
  describe('getImageDimensions', () => {
    ...
    it('should parse malformed JPEG dimensions (fallback)', () => {
    ...
    it('should parse WebP VP8 dimensions (lossy)', () => {
      // Create lossy VP8 WebP with width=24, height=24
      const data = new Uint8Array(40)
      const dv = new DataView(data.buffer)
      ...
      // Dimensions (14 bits each)
      dv.setUint16(26, 24, true) // width
      dv.setUint16(28, 24, true) // height

      const result = getImageDimensions(data.slice(0, 30))
      expect(result).toEqual({ width: 24, height: 24, type: 'webp' })
    })

    it('should handle malformed WebP dimensions', () => {
