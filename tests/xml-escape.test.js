...
describe('xml-escape utility', () => {
  ...
  test('should escape multiple special characters', () => {
    expect(escapeXml('<font name="Arial & Helvetica">')).toBe(
  ...
  test('should prevent XML injection attack', () => {
    ...
    expect(escaped).toBe(
      '&quot;&gt;&lt;script&gt;alert(&quot;XSS&quot;)&lt;/script&gt;&lt;w:rFonts w:ascii=&quot;'
    )
  ...
  test('should preserve normal text between special characters', () => {
    expect(escapeXml('Normal & Text < With > Special "Characters"')).toBe(
      'Normal &amp; Text &lt; With &gt; Special &quot;Characters&quot;'
    )
  })
})
